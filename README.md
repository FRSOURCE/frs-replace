...
| 2    | replace-in-file (sync)        | 0.43 ± 2.10%         | +21.16%                                                                       |
| 3    | @frsource/frs-replace (async) | 1.63 ± 2.06%         | +357.10%                                                                      |
| 4    | replace-in-file (async)       | 2.67 ± 1.84%         | +650.68%                                                                      |
...
| 2    | replaceString                 | 0.00 ± 0.48%         | +23.40%                                                                       |
| 3    | @frsource/frs-replace (async) | 0.00 ± 0.59%         | +29.93%                                                                       |
