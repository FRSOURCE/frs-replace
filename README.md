...
| 2    | replace-in-file (sync)        | 0.75 ± 1.65%         | +97.37%                                                                       |
| 3    | @frsource/frs-replace (async) | 1.78 ± 1.69%         | +369.26%                                                                      |
| 4    | replace-in-file (async)       | 2.89 ± 1.28%         | +659.83%                                                                      |
...
| 2    | @frsource/frs-replace (async) | 0.01 ± 0.26%         | +9.37%                                                                        |
| 3    | replaceString                 | 0.16 ± 1.02%         | +1974.43%                                                                     |
