...
| 2    | replace-in-file (sync)        | 0.47 ± 2.77%         | +24.61%                                                                       |
| 3    | @frsource/frs-replace (async) | 1.79 ± 1.60%         | +378.03%                                                                      |
| 4    | replace-in-file (async)       | 2.99 ± 2.11%         | +695.70%                                                                      |
...
| 2    | replaceString                 | 0.00 ± 0.53%         | +22.01%                                                                       |
| 3    | @frsource/frs-replace (async) | 0.00 ± 0.48%         | +31.45%                                                                       |
