...
| 2    | replace-in-file (async)       | 0.73 ± 1.57%         | +59.46%                                                                       |
| 3    | @frsource/frs-replace (async) | 1.87 ± 1.33%         | +305.91%                                                                      |
| 4    | replace-in-file (sync)        | 3.01 ± 1.51%         | +553.58%                                                                      |
...
| 2    | @frsource/frs-replace (async) | 0.01 ± 0.27%         | +11.32%                                                                       |
| 3    | replaceString                 | 0.09 ± 0.76%         | +922.28%                                                                      |
